...
public class SaveEchessFinishedGamesTask extends AbstractUpdateTask<TacticItem, Long> {

    private ContentResolver contentResolver;
    private QueryParams params;
	private List<TacticItem> tacticsBatch;

    public SaveEchessFinishedGamesTask(TaskUpdateInterface<TacticItem> taskFace, List<TacticItem> tacticsBatch) {
        super(taskFace);
