...
public class DbScheme {
	...
	static final int DATABASE_VERSION = 100;  // change version on every DB scheme changes
	...
	public static final String V_IS_TOURNAMENT_GAME = "is_tournament_game";
	public static final String V_IS_OPPONENT_ON_VACATION = "is_opponent_on_vacation";
	...
	public static final String V_PREVIEW_BODY = "preview_body";
	...
	public static final String V_WEB_URL = "web_url";
	...
	void createMainTables() {
		...
		createTablesArray[Tables.DAILY_CURRENT_GAMES.ordinal()] = createTableForName(Tables.DAILY_CURRENT_GAMES)
				...
				+ addField_Int(V_IS_TOURNAMENT_GAME)
				+ addField_Int(V_IS_OPPONENT_ON_VACATION)
		...
		createTablesArray[Tables.ARTICLE_DIAGRAMS.ordinal()] = createTableForName(Tables.ARTICLE_DIAGRAMS)
				+ addField_Int(V_ID)
				+ addField_Int(V_BODY, true);
		...
		createTablesArray[Tables.LESSONS_USER_LESSONS.ordinal()] = createTableForName(Tables.LESSONS_USER_LESSONS)
				...
				+ addField_Text(V_CURRENT_POINTS)
	...
	void createNotificationsTables() {
		createTablesArray[Tables.NOTIFICATION_YOUR_MOVE.ordinal()] = createTableForName(Tables.NOTIFICATION_YOUR_MOVE)
				+ addField_Long(V_ID) // game Id
				+ addField_Text(V_LAST_MOVE_TO_SQUARE)
				+ addField_Text(V_OTHER_USER_USERNAME)
				+ addField_Text(V_USER, true); // current auth user
		...
		createTablesArray[Tables.NOTIFICATION_GAMES_OVER.ordinal()] = createTableForName(Tables.NOTIFICATION_GAMES_OVER)
				+ addField_Long(V_ID) // gameId
				+ addField_Text(V_USER) // current auth user
				+ addField_Text(V_USERNAME) // opponent name
				+ addField_Text(V_MESSAGE)
				+ addField_Text(V_USER_AVATAR, true);
	}
