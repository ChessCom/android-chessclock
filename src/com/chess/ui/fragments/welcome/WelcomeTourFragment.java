...
public class WelcomeTourFragment extends CommonLogicFragment implements YouTubePlayer.OnFullscreenListener {
	...
	public static WelcomeTourFragment createInstance(FragmentTabsFace parentFace) {
...
//		logTest(" WelcomeTourFragment - onPause youtubeFragmentGoFullScreen = " + youtubeFragmentGoFullScreen);
	...
	private class WelcomePagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			switch (position) {
				...
				closeYouTubeBtn1.setOnClickListener(WelcomeTourFragment.this);
				...
				if (!initiatedFirst) {
					...
					firstView.findViewById(R.id.playBtn1).setOnClickListener(WelcomeTourFragment.this);
				...
				closeYouTubeBtn2.setOnClickListener(WelcomeTourFragment.this);
				...
				if (!initiatedSecond) {
					...
					secondView.findViewById(R.id.playBtn2).setOnClickListener(WelcomeTourFragment.this);
				...
				closeYouTubeBtn3.setOnClickListener(WelcomeTourFragment.this);
				...
				if (!initiatedThird) {
					...
					thirdView.findViewById(R.id.playBtn3).setOnClickListener(WelcomeTourFragment.this);
				...
				case 3:
					...
					view.findViewById(R.id.completeSignUpBtn).setOnClickListener(WelcomeTourFragment.this);
					view.findViewById(R.id.loginLinkTxt).setOnClickListener(WelcomeTourFragment.this);
	...
	private class RegisterUpdateListener extends CommonLogicFragment.ChessUpdateListener<RegisterItem> {
		...
		public void updateData(RegisterItem returnedObj) {
			...
			getAppData().setUsername(username);
