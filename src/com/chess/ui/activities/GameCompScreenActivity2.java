 ...
 */
public class GameCompScreenActivity2 extends GameBaseActivity2 implements GameCompActivityFace {
	...
	protected void widgetsInit() {
		...
		if (AppData.isComputerGameMode(boardView.getBoardFace())
				&& !preferences.getString(AppConstants.SAVED_COMPUTER_GAME, StaticData.SYMBOL_EMPTY)
				.equals(StaticData.SYMBOL_EMPTY)) { // if load game
			loadSavedGame();
	...
	private class MenuOptionsDialogListener implements DialogInterface.OnClickListener {
		...
		public void onClick(DialogInterface dialogInterface, int i) {
			...
			switch (i) {
				case NEW_GAME_WHITE: {
					boardView.setBoardFace(new ChessBoard2(GameCompScreenActivity2.this));
