...
public class ChatLiveActivity2 extends LiveBaseActivity2 implements OnClickListener {
	...
	public void onMessageReceived(){
		...
		chatItems.clear();
		chatItems.addAll(LccHolder2.getInstance(this).getMessagesList(gameId));
	...
	private class SendMessageTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... voids) {
			...
			LccHolder2.getInstance(getContext()).sendChatMessage(gameId, getTextFromField(sendEdt));
			return null;
		}
	}
}
