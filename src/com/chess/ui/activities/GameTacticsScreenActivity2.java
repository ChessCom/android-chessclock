 ...
 */
public class GameTacticsScreenActivity2 extends GameBaseActivity2 implements GameTacticsActivityFace {
...
//										+ AppConstants.TACTICS_ID_PARAMETER + tactic.values.get(AppConstants.ID)
...
//									+ preferences.getString(AppConstants.USER_TOKEN, StaticData.SYMBOL_EMPTY)
//									+ AppConstants.TACTICS_ID_PARAMETER + tactic.values.get(AppConstants.ID)
//									+ AppConstants.PASSED_PARAMETER + 0 + AppConstants.CORRECT_MOVES_PARAMETER + getBoardFace().getTacticsCorrectMoves() + AppConstants.SECONDS_PARAMETER + getBoardFace().getSec(),
//							progressDialog = new MyProgressDialog(ProgressDialog.show(this, null, getString(R.string.loading), true)));
//				}
...
//					"http://www." + LccHolder.HOST + AppConstants.API_TACTICS_TRAINER_ID_PARAMETER
//							+ preferences.getString(AppConstants.USER_TOKEN, StaticData.SYMBOL_EMPTY)
//							+ AppConstants.TACTICS_ID_PARAMETER + id,
...
//		}
	...
	private class GetTacticsUpdateListener extends ChessUpdateListener2 {
		...
		public void updateData(String returnedObj) {
			boardView.setBoardFace(new ChessBoard2(GameTacticsScreenActivity2.this));
...
//					update(CALLBACK_REPAINT_UI);
	...
	private class TacticsCorrectUpdateListener extends ChessUpdateListener2 {
...
//				.create();
	...
	private class TacticsWrongUpdateListener extends ChessUpdateListener2 {
...
//	private DialogInterface.OnClickListener firstTacticsDialogListener = new DialogInterface.OnClickListener() {
//		@Override
...
//	private DialogInterface.OnClickListener axTacticsDialogListener = new DialogInterface.OnClickListener() {
//		@Override
//		public void onClick(DialogInterface dialog, int whichButton) {
//			if (whichButton == DialogInterface.BUTTON_POSITIVE) {
//				FlurryAgent.onEvent(FlurryData.UPGRADE_FROM_TACTICS, null);
...
//	private DialogInterface.OnClickListener hundredTacticsDialogListener = new DialogInterface.OnClickListener() {
//		@Override
//		public void onClick(DialogInterface dialog, int whichButton) {
//			currentTacticProblem = 0;
//			onBackPressed();
...
//	};
	...
	private DialogInterface.OnClickListener offlineModeDialogListener = new DialogInterface.OnClickListener() {
		@Override
		public void onClick(DialogInterface dialog, int whichButton) {
			if (whichButton == DialogInterface.BUTTON_POSITIVE) {
				getGuestTacticsGame();
