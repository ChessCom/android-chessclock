 ...
 */
public abstract class LiveBaseActivity2 extends CoreActivityActionBar2 {
	...
	private class LiveOuterChallengeListener implements OuterChallengeListener {
		...
		public void showDelayedDialog(Challenge challenge) {
			...
			PopupDialogFragment popupDialogFragment = PopupDialogFragment.newInstance(popupItem, LiveBaseActivity2.this);
