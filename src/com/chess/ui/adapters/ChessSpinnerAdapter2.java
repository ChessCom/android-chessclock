 ...
 */
public class ChessSpinnerAdapter2 extends ArrayAdapter<String> {

	private Context context;

	public ChessSpinnerAdapter2(Context context, int entries) {
	...
	public ChessSpinnerAdapter2(Context context, String[] entries) {
