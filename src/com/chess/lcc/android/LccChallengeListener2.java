...
public class LccChallengeListener2 implements ChallengeListener {
    ...
    public LccChallengeListener2(LccHolder2 lccHolder) {
//		if (lccHolder == null) {
...
//		}
	...
	public void onChallengeReceived(Challenge challenge) {
		...
		if (challenge.getTo().equals(lccHolder.getUser().getUsername())) {
			SoundPlayer.getInstance(lccHolder.getAndroidStuff().getContext()).playNotify();
