...
public class ChessClock2 {
	...
	public ChessClock2(LccHolder2 lccHolder, boolean isWhite, int time) {
	...
	public void paint() {
		final LccEventListener eventListener = lccHolder.getAndroidStuff().getLccEventListener();
