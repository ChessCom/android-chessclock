...
public class ChatListenerImpl2 implements ChatListener {

    private static final String TAG = "ChatListenerImpl";
	private final LccHolder2 lccHolder;

    public ChatListenerImpl2(LccHolder2 lccHolder) {
		if (lccHolder == null) {
...
//			lccHolder.getAndroidStuff().getContext().getCurrentGame().values.put(GameItem.HAS_NEW_MESSAGE, "1");
