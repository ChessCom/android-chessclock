...
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
     ...
     */
    public static final String SHOW_PICTURES_BUNDLE_KEY = "com.PickerFragment.ShowPictures";
    /**
     ...
     */
    public static final String EXTRA_FIELDS_BUNDLE_KEY = "com.PickerFragment.ExtraFields";
    /**
     * The key for a boolean parameter in the fragment's Intent bundle to indicate whether the
     * picker should display a title bar with a Done button.
     */
    public static final String SHOW_TITLE_BAR_BUNDLE_KEY = "com.PickerFragment.ShowTitleBar";
    /**
     * The key for a String parameter in the fragment's Intent bundle to indicate the text to
     * display in the title bar.
     */
    public static final String TITLE_TEXT_BUNDLE_KEY = "com.PickerFragment.TitleText";
    /**
     * The key for a String parameter in the fragment's Intent bundle to indicate the text to
     * display in the Done btuton.
     */
    public static final String DONE_BUTTON_TEXT_BUNDLE_KEY = "com.PickerFragment.DoneButtonText";
    ...
    abstract class LoadingStrategy {
        ...
        public void attach(GraphObjectAdapter<T> adapter) {
            ...
            loader.setOnErrorListener(new com.facebook.widget.GraphObjectPagingLoader.OnErrorListener() {
                @Override
