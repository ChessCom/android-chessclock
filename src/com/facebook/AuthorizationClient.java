...
class AuthorizationClient implements Serializable {
	...
	private static final String WEB_VIEW_AUTH_HANDLER_STORE =
			"com.AuthorizationClient.WebViewAuthHandler.TOKEN_STORE_KEY";
	...
	class GetTokenAuthHandler extends AuthHandler {
		...
		boolean tryAuthorize(final AuthorizationRequest request) {
			...
			com.facebook.GetTokenClient.CompletedListener callback = new com.facebook.GetTokenClient.CompletedListener() {
				@Override
