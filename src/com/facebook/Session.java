...
public class Session implements Serializable {
    ...
    public final boolean onActivityResult(Activity currentActivity, int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            com.facebook.AuthorizationClient.Result result = (com.facebook.AuthorizationClient.Result) data.getSerializableExtra(
    ...
    private void handleAuthorizationResult(int resultCode, com.facebook.AuthorizationClient.Result result) {
        AccessToken newToken = null;
        Exception exception = null;
    ...
    private Intent getLoginActivityIntent(AuthorizationRequest request) {
        ...
        com.facebook.AuthorizationClient.AuthorizationRequest authClientRequest = request.getAuthorizationClientRequest();
    ...
    private boolean tryLegacyAuth(final AuthorizationRequest request) {
        ...
        authorizationClient.setOnCompletedListener(new com.facebook.AuthorizationClient.OnCompletedListener() {
            @Override
            public void onCompleted(com.facebook.AuthorizationClient.Result result) {
                int activityResult;
    ...
    public static class AuthorizationRequest implements Serializable {
        ...
        com.facebook.AuthorizationClient.AuthorizationRequest getAuthorizationClientRequest() {
            com.facebook.AuthorizationClient.StartActivityDelegate delegate = new com.facebook.AuthorizationClient.StartActivityDelegate() {
                @Override
                public void startActivityForResult(Intent intent, int requestCode) {
            ...
            return new com.facebook.AuthorizationClient.AuthorizationRequest(loginBehavior, requestCode, isLegacy,
