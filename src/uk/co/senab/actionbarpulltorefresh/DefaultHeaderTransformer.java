...
import uk.co.senab.actionbarpulltorefresh.platform.SDK11;
...
public class DefaultHeaderTransformer extends PullToRefreshAttacher.HeaderTransformer {
    ...
    private RoboTextView mHeaderTextView;
    ...
    public void onViewCreated(Activity activity, View headerView) {
        ...
        mHeaderTextView = (RoboTextView) headerView.findViewById(R.id.ptr_text);
