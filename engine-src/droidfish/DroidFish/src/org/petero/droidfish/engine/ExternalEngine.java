...
public class ExternalEngine extends UCIEngineBase {
    ...
    protected static final String intSfPath = "/data/data/com.chess/internal_sf";
    private static final String exePath = "/data/data/com.chess/engine.exe";
    ...
    protected void startProcess() {
        try {
			//Log.d(MyFish.TAG, "engineFileName " + engineFileName);
