...
public class Position {
    ...
    public final void unMakeMove(Move move, UndoInfo ui/*, boolean print*/) {
		/*if (print) {
			Log.d("", "");
		}*/

        setWhiteMove(!whiteMove);
		//Log.d("FISHLOG", "UNDO unMakeMove move.to " + move.to);
		//Log.d("FISHLOG", "UNDO unMakeMove squares[move.to] " + squares[move.to]);
        int p = squares[move.to];
		//Log.d("FISHLOG", "UNDO unMakeMove move.from " + move.from);
