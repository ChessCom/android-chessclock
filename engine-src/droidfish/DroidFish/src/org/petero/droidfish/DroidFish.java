...
public class DroidFish extends Activity implements GUIInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tcData.setTimeControl(timeControl, movesPerSession, timeIncrement, 5000);
		ctrl.newGame(gameMode, tcData, 0);
		{
			byte[] data = null;
			int version = 1;
	...
	public void setPosition(Position pos, String variantInfo, ArrayList<Move> variantMoves) {
		Log.d("", "setPosition pos " + pos);
		Log.d("", "setPosition variantInfo " + variantInfo);
		Log.d("", "setPosition variantMoves " + variantMoves);
